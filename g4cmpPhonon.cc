...
int main(int argc,char** argv)
{
 ...
 //
 // G4cout << "top qubit y: " << pdp_qubit_top_hole_ypos << ", middle y: " << pdp_qubit_middle_hole_ypos << ", bottom y: " << pdp_qubit_bottom_hole_ypos << ", height: " << pdp_qubit_hole_length / 2.0 << G4endl;
